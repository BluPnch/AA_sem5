...
\lstset{
  ...
  morekeywords={class, interface, namespace, using, public, private, protected, static, void, string, int, bool, var, return, if, else, for, foreach, while, try, catch, finally, switch, case, default, new, this, base, enum, delegate, event, readonly, sealed, abstract, virtual, override, internal, extern, in, out} % Добавление специфичных для C# ключевых слов
}
